...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetNormal-request>)))
  ...
  "78e9a71258a9d6fdc4aeba5a9c33a01e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetNormal-request)))
  "Returns md5sum for a message object of type 'GetNormal-request"
  "78e9a71258a9d6fdc4aeba5a9c33a01e")
...
(cl:defmethod yaw-val ((m <GetNormal-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hector_nav_msgs-srv:yaw-val is deprecated.  Use hector_nav_msgs-srv:yaw instead.")
  (yaw m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetNormal-response>)))
  ...
  (cl:format cl:nil "geometry_msgs/Vector3 normal~%float32 yaw~%~%~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetNormal-response)))
  "Returns full string definition for message of type 'GetNormal-response"
  (cl:format cl:nil "geometry_msgs/Vector3 normal~%float32 yaw~%~%~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
